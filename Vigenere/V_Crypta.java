...
public class V_Crypta {
	...
	{
		byte[] ct = CryptoTools.fileToBytes("C:\\Users\\Danie\\eclipse-workspace\\Labs\\EECS3481\\src\\data\\MSGV.ct");
		for (int k = 1; k < 50; k++)
		{
		...
		int keyLength = 9;//find the key length using the above for loop
	...
	//Activity A first word LABORATORY
	//Rehearsal first word The
}
